...
var menuOtro = class {
  ...
  async menuOtro(app2, registro) {
    const opcionesOtro = ["Habituales", "Ninguno", "Areas de Vida", "Areas de Inter\xE9s", "Proyectos de Q", "Proyectos GTD", "Tema de Inter\xE9s", "Recurso Recurrente", "Buscar"];
    ...
    try {
      ...
      switch (selectionOtro) {
        case "hab":
          ...
          break;
        case "nin":
          temaOtro = await this.ninguno(app2);
          break;
        case "actsAV":
        case "actsAI":
        case "actsPQ":
